...
import { N as NullProtoObj } from "../../main.mjs";
...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v--vRmybxW.mjs");
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./router-BZtNflO-.mjs").then(function(n) {
        return n.r;
      });
    }
    if (startEntry === null) {
